...
resp = "si"
while(resp !="no"):
    print("*--- Programa para cifrar y decodificar una frase con el algoritmo Cesar ---*")
    fra = input("Que desea hacer cifrar/decodificar o salir?: ")
    fra = fra.lower()
    if fra == "cifrar":
        ...
        print("-------------------------------------------------")
        resp = input("Desea cifrar o decodificar otra frase(si/no)?: ")
        resp = resp.lower()
        print("-------------------------------------------------")
    elif(fra == "decodificar"):
        frase_cifrada = input("ingresa la frase a decodificar: ")
        frase_decodificada = decodificar(alfabeto,3,frase_cifrada)
        print("(2)--El mensaje decodificado es: ", frase_decodificada)
        print("-------------------------------------------------")
        resp = input("Desea cifrar o decodificar otra frase(si/no)?: ")
        resp = resp.lower()
        print("-------------------------------------------------")
